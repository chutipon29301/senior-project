...
export class ChaincodeController {
    ...
    @Post()
    public async installChaincode(@Body() { peers, username, organizationName }: InstallChaincodeDto) {
        return this.chaincodeService.installChaincode(peers, username, organizationName);
    }

    @Post('instantiate/:channelName')
    public async instantiateChaincode(
        @Param('channelName') channelName: string,
        @Body() { peers, functionName, args, username, organizationName }: InstantiateChaincodeDto,
    ) {
        return this.chaincodeService.instantiateChaincode(peers, channelName, functionName, args, username, organizationName);
    }
    ...
    public async invokeTransaction(
        ...
        @Body() {peers, fcn, args, username, organizationName}: InvokeChaincodeDto) {
        return this.chaincodeService.invokeChaincode(
            peers, channelName, chaincodeName, fcn, args, username, organizationName);
    }
